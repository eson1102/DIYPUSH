...
response = requests.get(
    "https://subapi.cmliussss.net/sub?&url=https%3A%2F%2Fcfdingyue-4lu.pages.dev%2Fa5ce27a6-76df-48da-be62-493fbda9a3af"
    "&target=clash&emoji=true&append_type=true&append_info=false&scv=false&udp=false&list=false"
