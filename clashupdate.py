...
# 使用请求库获取ini文件的内容
response = requests.get("https://subapi.fxxk.dedyn.io/sub?&url=https://raw.githubusercontent.com/eson1102/rules/refs/heads/main/path/in/repo/bbb.txt&target=clash&config=https://raw.githubusercontent.com/eson1102/rules/refs/heads/main/ACL4SSR_Online_Mini_AdblockPlus.ini&emoji=true&append_type=true&append_info=true&scv=true&udp=false&list=false&sort=false&fdn=true&insert=false",timeout=200)
