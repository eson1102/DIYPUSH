...
# 使用请求库获取ini文件的内容
response = requests.get("https://url.v1.mk/sub?target=clash&url=https://subscribe.xsus.net.co/api/v1/client/subscribe?token=0ae03574013e75ca024d91c336ae02a2&insert=false&config=https://github.com/eson1102/rules/blob/main/Mini_MultiCountry.ini&emoji=true&list=false&xudp=false&udp=false&tfo=false&expand=true&scv=false&fdn=false&new_name=true",timeout=20)
